...
void
compute_w_coefficients_seq(int n, int a, int b, COMPLEX * W)
{
	double twoPiOverN;
	int k;
	REAL s, c;
...
void
unshuffle(int a, int b, COMPLEX * in, COMPLEX * out, int r, int m)
{
	int i, j;
	int r4 = r & (~0x3);
	const COMPLEX *ip;
...
void
unshuffle_seq(int a, int b, COMPLEX * in, COMPLEX * out, int r, int m)
{
	int i, j;
	int r4 = r & (~0x3);
	const COMPLEX *ip;
...
void
fft_twiddle_gen(int i, int i1, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int r, int m)
{
	oneapi::tbb::task_group g;
	if (i == i1 - 1) {
		g.run([=] {
...
void
fft_twiddle_gen_seq(int i, int i1, COMPLEX * in, COMPLEX * out, COMPLEX * W,
...
void
fft_twiddle_2(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m)
{
	int l1, i;
	COMPLEX *jp, *kp;
...
void
fft_twiddle_2_seq(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m)
{
	int l1, i;
	COMPLEX *jp, *kp;
	REAL tmpr, tmpi, wr, wi;
...
void
fft_unshuffle_2_seq(int a, int b, COMPLEX * in, COMPLEX * out, int m)
{
	int i;
	const COMPLEX *ip;
	COMPLEX *jp;
...
void
fft_twiddle_4(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m)
{
	int l1, i;
	COMPLEX *jp, *kp;
	REAL tmpr, tmpi, wr, wi;
...
void
fft_twiddle_4_seq(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m)
{
	int l1, i;
	COMPLEX *jp, *kp;
	REAL tmpr, tmpi, wr, wi;
...
void
fft_unshuffle_4_seq(int a, int b, COMPLEX * in, COMPLEX * out, int m)
{
	int i;
	const COMPLEX *ip;
	COMPLEX *jp;
...
void
fft_twiddle_8(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m)
{
	int l1, i;
	COMPLEX *jp, *kp;
	REAL tmpr, tmpi, wr, wi;
...
void
fft_twiddle_8_seq(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m)
{
	int l1, i;
	COMPLEX *jp, *kp;
	REAL tmpr, tmpi, wr, wi;
...
void
fft_unshuffle_8_seq(int a, int b, COMPLEX * in, COMPLEX * out, int m)
{
	int i;
	const COMPLEX *ip;
	COMPLEX *jp;
...
void
fft_twiddle_16(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m)
{
	int l1, i;
	COMPLEX *jp, *kp;
	REAL tmpr, tmpi, wr, wi;
...
void
fft_twiddle_16_seq(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m)
{
	int l1, i;
	COMPLEX *jp, *kp;
	REAL tmpr, tmpi, wr, wi;
...
void
fft_unshuffle_16_seq(int a, int b, COMPLEX * in, COMPLEX * out, int m)
{
	int i;
	const COMPLEX *ip;
	COMPLEX *jp;
...
void
fft_twiddle_32(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m)
{
	int l1, i;
	COMPLEX *jp, *kp;
	REAL tmpr, tmpi, wr, wi;
...
void
fft_twiddle_32_seq(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m)
{
	int l1, i;
	COMPLEX *jp, *kp;
	REAL tmpr, tmpi, wr, wi;
...
void
fft_unshuffle_32_seq(int a, int b, COMPLEX * in, COMPLEX * out, int m)
{
	int i;
	const COMPLEX *ip;
	COMPLEX *jp;
 ...
 */
void
fft_aux(int n, COMPLEX * in, COMPLEX * out, int *factors, COMPLEX * W, int nW)
{
	int r, m;
	int k;
...
void
fft_aux_seq(int n, COMPLEX * in, COMPLEX * out, int *factors, COMPLEX * W, int nW)
{
	int r, m;
	int k;
 ...
 */
extern "C" void
fft(int n, COMPLEX * in, COMPLEX * out)
{
...
extern "C" void
fft_seq(int n, COMPLEX * in, COMPLEX * out)
{
	int factors[40];		/* allows FFTs up to at least 3^40 */
	int *p = factors;
	int l = n;
...
extern "C" int
test_correctness(int n, COMPLEX *out1, COMPLEX *out2)
{
	int i;
